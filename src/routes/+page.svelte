...
<div class="space-y-12 text-xl">
    ...
    <div class="space-y-6">
        <p>
            I do a lot of programming with various different tools. I'm well
            versed with programming languages such as Java, C++, Python,
            JavaScript, and Rust.
        </p>
        <p>
            As a follower of Christ, I strive to glorify God in all that I do,
            including software development. I hope to create meaningful software
            that impacts others in a positive way.
        </p>
        <p>
        ...
        <p>
            I also write blog posts sometimes. Feel free to <a class="link" href="/blog">read them</a>.
            One of my posts was featured on a <a class="link" href="https://www.youtube.com/watch?v=8D7FZoQ-z20">YouTube video</a> with over <b>300k</b> views!
        </p>
    </div>
    <div>
                    ...
                    <div class="flex flex-row-reverse justify-between">
                        ...
                        {:else}
                            <Icon
                                ...
                                width="18"
                                height="18"
                                class="mt-4 block text-neutral-400"
                            />
                        {/if}
                        <div class="flex gap-2">
                            {#each project.tool_icons as icon}
                                ...
                                {:else}
                                    <Icon {icon} width="18" height="18" class="mt-4 block text-neutral-400" />
                                {/if}
                            {/each}
                        </div>
                    </div>
