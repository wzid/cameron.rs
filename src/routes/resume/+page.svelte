...
<div class="mt-4 space-y-3 text-neutral-700 sm:text-lg dark:text-neutral-300">
  ...
  <div class="resume-section">
    ...
    <div class="resume-content space-y-1">
      ...
      <p>
        <b>Developer Tools: </b> Git, Linux, VS Code, Visual Studio, Gradle, Maven, Cargo, CMake, Bash, NPM, MacOS
      </p>
      <p>
        <b>Mathematical Proficiency: </b> Calculus, Number Theory, Discrete Mathematics
      </p>
      <p>
        <b>Awards: </b> Dean's List, Placed 12th in the Mid-Atlantic Region of the International Collegiate Programming Competition
      </p>
    </div>
  </div>
  <div class="resume-section">
    ...
    <div class="resume-content space-y-5">
      <div class="space-y-1">
        ...
        <ul class="list-inside list-disc pl-3 pt-1">
          <li>Prepared weekly presentations on advanced data structures and algorithms to over 40 club members</li>
          ...
          <li>Initiated Liberty University's first individual programming competition hosted at the university</li>
          <li>
      ...
      <div class="space-y-1">
        ...
        <ul class="list-inside list-disc pl-3 pt-1">
          ...
          <li>
            Wrote over <b>80 unit tests</b> to ensure code stability and long term support
          </li>
          <li>Demonstrated exceptional programming knowledge and debugging skills when encountering problems</li>
          <li>Documented new API endpoints for presentation at team meetings for collaborative feedback</li>
        </ul>
      </div>
      <div class="space-y-1">
        <div class="spread">
        ...
        <ul class="list-inside list-disc pl-3 pt-1">
          ...
          <li>Contributed over 30 problems and provided valuable feedback about discrepancies in the website</li>
        </ul>
      </div>
    </div>
  </div>
  <div class="resume-section">
    ...
    <div class="resume-content space-y-4">
      <div class="space-y-1">
        ...
        <ul class="list-inside list-disc pl-3 pt-1">
          <li>
            Club members are able to compete against one another through our competition page where we upload weekly
            problems
          </li>
          <li>
            Utilized the <b>Firebase Real-Time Database</b> to store user data and seamlessly implement statistics for each
            user
          </li>
      ...
      <div class="space-y-1">
        ...
        <ul class="list-inside list-disc pl-3 pt-1">
          ...
          <li>
            Optimized the algorithm's performance to use the least amount of memory possible through the use of bit
            manipulation
          </li>
          <li>
            Integrated the solver with a <b>GUI</b> and compiled it to my website using <b>Web Assembly</b>
          </li>
        </ul>
      </div>
      <div class="space-y-1">
        <div class="spread">
          <p>
            <b class="text-lg">Language Interpreter </b> |
            <i>Rust</i>
          </p>
        ...
        <ul class="list-inside list-disc pl-3 pt-1">
          ...
          <li>
            Added functionality to support conditionals, implicit and explicit returns, recursive functions, closures,
...
<style lang="postcss">
  .resume-section h2 {
    @apply border-b-[1px] font-serif text-2xl text-black dark:text-white;
  }
  ...
  .spread {
    @apply flex items-center justify-between font-serif text-black dark:text-white;
  }
